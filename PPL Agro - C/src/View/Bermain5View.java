 ...
 * @author adheraprabu
 */
public class Bermain5View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Label_pohon1_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, -1, -1));
        ...
        getContentPane().add(Label_pohon3_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 180, -1, -1));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Lahan/lahan5.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bermain5View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bermain5View().setVisible(true);
            }
        });
    }
