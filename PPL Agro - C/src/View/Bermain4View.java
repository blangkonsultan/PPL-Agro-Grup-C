 ...
 * @author adheraprabu
 */
public class Bermain4View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Button_kotak1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, -1, -1));
        ...
        getContentPane().add(Button_kotak2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 270, -1, -1));
        ...
        getContentPane().add(Button_kotak3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 250, -1, -1));
        ...
        getContentPane().add(Button_kotak4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 380, -1, -1));
        ...
        getContentPane().add(Button_kotak5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 340, -1, -1));
        ...
        getContentPane().add(Button_kotak6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 470, -1, -1));
        ...
        getContentPane().add(Button_kotak7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, -1, -1));
        ...
        getContentPane().add(Button_kotak8, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 580, -1, -1));
        ...
        getContentPane().add(Button_kotak9, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 370, -1, -1));
        ...
        getContentPane().add(Button_tas, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 675, 70, 60));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Lahan/lahan4-1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bermain4View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bermain4View().setVisible(true);
            }
        });
    }
